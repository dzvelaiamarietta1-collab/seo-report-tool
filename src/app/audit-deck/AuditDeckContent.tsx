      ...
      findings: [
        {
          ...
          solution:
            "დაუყოვნებლივ შეიქმნას XML Sitemap (ka/en ვერსიებით) და გაიგზავნოს Google Search Console-ში.",
        },
        {
          num: "1.2",
          ...
          solution:
            "დაემატოს თვითმიმთითებელი (self-referencing) canonical tag ყველა გვერდზე.",
        },
        {
          num: "1.3",
          ...
          solution:
            "დაიწეროს უნიკალური, საკვანძო-სიტყვიანი Description ყველა პროდუქტსა და კატეგორიაზე.",
        },
        {
          num: "1.4",
          ...
          solution:
            "დაინერგოს Product, LocalBusiness და BreadcrumbList schema - განსაკუთრებით პროდუქტებსა და სერვისებზე.",
        },
        {
          num: "1.5",
          ...
          solution:
            "ჩაირთოს caching (WP Rocket) და CDN; ფოტოები გადავიდეს WebP-ში lazy-load-ით.",
        },
        {
          num: "1.6",
          ...
          solution:
            "ფოტოები გადავიდეს WebP-ში და შეიკუმშოს; დაემატოს აღწერითი ALT და width/height.",
        },
        {
          num: "1.7",
          ...
          solution: "სერვერზე ჩაირთოს ყველა უსაფრთხოების header.",
        },
      ],
    },
    {
      ...
      findings: [
        {
          ...
          solution:
            "თითო გვერდს/პროდუქტს უნდა ჰქონდეს უნიკალური, საკვანძო-სიტყვიანი Title (50-60 სიმბ.) - ბრენდის სახელით.",
        },
        {
          num: "2.2",
          ...
          solution:
            "თითო გვერდს უნდა ჰქონდეს ერთი უნიკალური H1; სათაურები იერარქიულად დალაგდეს H1→H2→H3.",
        },
      ],
    },
  ],
...
function mapScreamingFrogToFindings(rows: string[][]): {
  ...
  if (titleTooShort > 0) {
    sf(
      ...
      [
        ...
        "მოკლე Title ვერ იყენებს Google-ის შედეგებში არსებულ ხელმისაწვდომ ადგილს და ვერ ცემს კონტექსტს.",
      ],
  ...
  if (metaTooShort > 0 || metaTooLong > 0) {
    sf(
      ...
      "Description-ის ოპტიმალური სიგრძეა 140-160 სიმბოლო - Google ცემს ამდენ ადგილს შედეგებში."
    );
  }
  if (h1Missing > 0) {
    sf(
...
const RM_TESTS: Record<string, RmTestMeta> = {
  "Common Keywords": {
    ...
    fail: {
      ...
      solution: "გვერდის ძირითადი თემა მკაფიოდ უნდა გამოიკვეთოს 4-6-ჯერ განმეორებადი საკვანძო ფრაზებით - ბუნებრივად, კონტექსტში.",
    },
  },
  "SEO Description": {
    ...
    fail: {
      ...
      solution: "თითო გვერდს მიენიჭოს უნიკალური Meta Description 140-160 სიმბოლოს ფარგლებში, რომელშიც შევა მთავარი საკვანძო ფრაზა და ღირებულების შეთავაზება.",
    },
    warn: {
      problem: [
        "Meta Description არსებობს, მაგრამ მისი სიგრძე ოპტიმალურს ვერ აღწევს - ან ძალიან მოკლეა, ან Google-ის შედეგებში ჩამოეჭრება.",
      ],
      solution: "Description გადასახედია 140-160 სიმბოლომდე ისე, რომ მთავარი ფრაზა და CTA თავში დარჩეს.",
    },
  },
  "H1 Heading": {
    ...
    fail: {
      ...
      solution: "თითო გვერდს უნდა ჰქონდეს ერთი უნიკალური H1 ტეგი, რომელშიც შევა მთავარი საკვანძო ფრაზა.",
    },
  },
  "H2 Headings": {
    ...
    fail: {
      problem: [
        ...
        "H2 აუმჯობესებს კონტენტის სკანირებას როგორც მკითხველისთვის, ისე Google-ისთვის - უხეშებს გვერდის სტრუქტურულ ჩარჩოს.",
      ],
      solution: "კონტენტი დაიყოს 3-6 თემატურ ბლოკად H2-ით, რომელშიც შევა მეორადი საკვანძო ფრაზები.",
    },
  },
  "Image ALT Attributes": {
    ...
    fail: {
      ...
      solution: "თითო სურათს მიენიჭოს მოკლე ALT (5-10 სიტყვა), რომელშიც აღწერილია სურათის შინაარსი და, თუ ბუნებრივად ჯდება, საკვანძო ფრაზაც.",
    },
  },
  "Keywords in Title & Description": {
    ...
    fail: {
      ...
      solution: "Title-სა და Description-ში დაემატოს 1-2 ფრაზა, რომელიც კონტენტში ბუნებრივად რამდენჯერმე გვხვდება.",
    },
  },
  "Links Ratio": {
    ...
    fail: {
      ...
      solution: "შიდა ლინკები გადაანაწილდეს თემატურად დაკავშირებულ გვერდებზე; გარე ლინკები მხოლოდ რელევანტურ წყაროებზე rel='noopener' ატრიბუტით.",
    },
  },
  "SEO Title": {
    ...
    fail: {
      ...
      solution: "ყველა გვერდს მიენიჭოს უნიკალური Title 50-60 სიმბოლოს ფარგლებში, რომელშიც თავში დგას მთავარი საკვანძო ფრაზა.",
    },
    warn: {
      problem: [
        "Title არსებობს, მაგრამ ან 60 სიმბოლოს აღემატება და Google-ის შედეგებში ჩამოეჭრება, ან 30 სიმბოლოზე ნაკლებია და კონტექსტს ვერ ცემს.",
      ],
      solution: "Title გადასახედია 50-60 სიმბოლომდე.",
    },
  },
  "Create a responsive site": {
    ...
    fail: {
      ...
      solution: "თემაში დაემატოს responsive CSS @media query-ები მინიმუმ 768px და 480px breakpoint-ებზე.",
    },
  },
  "Homepage Is Reachable": {
    ...
    fail: {
      ...
      solution: "სასწრაფოდ შესამოწმებელია ჰოსტინგი, DNS და სერვერული ლოგები.",
    },
  },
  "Canonical Tag": {
    ...
    fail: {
      ...
      solution: "ყველა გვერდის <head>-ში დაემატოს self-referencing canonical tag.",
    },
  },
  "Noindex Meta": {
    ...
    fail: {
      ...
      solution: "noindex meta tag მოვაშოროთ ან გადავიდეს index-ზე, თუ ეს გვერდი არ უნდა იყოს დახურული.",
    },
  },
  "WWW Canonicalization": {
    ...
    fail: {
      ...
      solution: "ერთი ვერსია (ჩვეულებრივ non-www) გახდეს კანონიკური და მეორედან 301-ით გადამისამართდეს.",
    },
  },
  "OpenGraph Meta": {
    ...
    fail: {
      ...
      solution: "<head>-ში დაემატოს og:title, og:description, og:image, og:type და twitter:card meta tag-ები.",
    },
  },
  "Schema Meta Data": {
    ...
    fail: {
      ...
      solution: "დაემატოს JSON-LD: Organization (კომპანიის შესახებ), BreadcrumbList (ნავიგაცია), პროდუქტ/სერვის გვერდებზე Product ან Service, FAQ გვერდებზე FAQPage.",
    },
  },
  "Sitemaps": {
    title: "XML Sitemap",
    ...
    fail: {
      ...
      solution: "გენერირდეს /sitemap.xml (Rank Math ან Yoast ავტომატურად ქმნის), დარეგისტრირდეს Google Search Console-ში.",
    },
  },
  "Robots.txt": {
    ...
    fail: {
      ...
      solution: "შეიქმნას /robots.txt სტანდარტული შინაარსით (Allow: /, Disallow: /wp-admin/, Sitemap: ...).",
    },
    warn: {
      problem: [
      ...
      solution: "robots.txt გაიხსნას და თითო Disallow ხაზი დადასტურდეს, რომ შესაბამისი გვერდი მართლა არ უნდა ინდექსირდეს.",
    },
  },
  "Keep your content fresh": {
    ...
    fail: {
      ...
      solution: "გვერდი გადასახედია, კონტენტი ნაწილობრივ განახლდეს (ფასები, თარიღები, შემთხვევები).",
    },
  },
  "Broken Links": {
    ...
    fail: {
      ...
      solution: "გატეხილი ლინკები აღსადგენია, ან წავიდეს 301 გადამისამართება სწორ URL-ზე.",
    },
  },
  "Page Size": {
    ...
    warn: {
      ...
      solution: "HTML-ი გაიწმინდოს - inline სტილების და სკრიპტების ცალკე ფაილებში გადატანა, არასაჭირო კომენტარების მოშორება.",
    },
  },
  "Response Time": {
    ...
    fail: {
      ...
      solution: "ჩაირთოს კეშირება (WP Rocket / LiteSpeed Cache), განიხილოს CDN-ის გამოყენება, ჰოსტინგი გადასახედია.",
    },
  },
  "Image Headers Expire": {
    title: "სურათების Cache hedader-ები",
    category: "tech",
    priority: 20,
    ...
    fail: {
      ...
      solution: "სერვერზე ჩაირთოს Expires ან Cache-Control header სურათებისთვის - მინიმუმ 30 დღით.",
    },
  },
  "Minify CSS": {
    ...
    warn: {
      ...
      solution: "ჩაირთოს CSS combine + minify (LiteSpeed Cache, WP Rocket, Autoptimize).",
    },
  },
  "Page Objects": {
    ...
    warn: {
      ...
      solution: "გაერთიანდეს CSS/JS ფაილები, არასაჭირო plugin-ები გაითიშოს, lazy-loading დაერთოს სურათებს.",
    },
  },
  "Minify Javascript": {
    ...
    warn: {
      ...
      solution: "JavaScript combine + minify ჩაირთოს (LiteSpeed Cache ან WP Rocket).",
    },
  },
  "Mobile Speed": {
    ...
    fail: {
      ...
      solution: "შემოწმდეს Core Web Vitals (LCP, INP, CLS) PageSpeed Insights-ით, გაუმჯობესდეს სურათების ფორმატი (WebP), lazy-loading, კრიტიკული CSS.",
    },
  },
  "Theme Visibility": {
    ...
    warn: {
      ...
      solution: "ეს უსაფრთხოების მცირე რისკია - საჭიროების შემთხვევაში თემის ვერსიული ინფორმაცია დაიფაროს.",
    },
  },
  "Visible Plugins": {
    ...
    warn: {
      ...
      solution: "plugin-ების ვერსიული ინფორმაცია დაიფაროს, /readme.html ფაილები წაიშალოს.",
    },
  },
  "Directory Listing": {
    ...
    fail: {
      ...
      solution: "Apache-ში დაემატოს 'Options -Indexes', Nginx-ში 'autoindex off;'.",
    },
  },
  "Secure Connection": {
    ...
    fail: {
      ...
      solution: "ჩაირთოს უფასო Let's Encrypt SSL სერტიფიკატი ჰოსტინგის პანელიდან.",
    },
  },
